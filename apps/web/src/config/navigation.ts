...
export const navigationConfig: NavItem[] = [
  ...
  { path: '/analytics', label: 'Analytics', icon: LineChart, roles: ['SUPER_ADMIN', 'ADMIN', 'MANAGER'] },
  { path: '/organization', label: 'Organization', icon: Building2, roles: ['SUPER_ADMIN', 'ADMIN'] },
  { path: '/users', label: 'Users', icon: Users, roles: ['SUPER_ADMIN', 'ADMIN'] },
  { path: '/audit', label: 'Audit Trail', icon: ShieldCheck, roles: ['SUPER_ADMIN'] },
